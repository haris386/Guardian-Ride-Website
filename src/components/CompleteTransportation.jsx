...
export default function CompleteTransportation() {
  return (
    <section className="w-full lg:max-w-[80%] mx-auto mt-24 flex flex-col space-y-6 px-[0px] lg:px-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-end md:items-end space-y-4 md:space-y-0">
        {/* Left Heading */}
        <h2 className="text-3xl sm:text-4xl md:text-4xl font-[500] text-gray-900 leading-snug">
          Your Complete <br /> Transportation Control Center
        </h2>
        {/* Right Paragraph */}
     <p className="max-w-md md:max-w-sm font-[400] text-[20px] capitalize">
