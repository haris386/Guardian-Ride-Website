...
export default function Footer() {
  return (
    <>
      ...
      >
        <div className="max-w-[93%] mx-auto grid grid-cols-1 lg:grid-cols-[85%_15%] gap-8 text-white">
          {/* Left Column */}
          ...
          {/* Right Column */}
          <div className="flex flex-col justify-between text-right space-y-10">
            {/* Row 1: Contact Us */}
            <div>
            ...
            {/* Row 2: Social Links */}
            <div className="flex flex-col items-start space-y-2 font-outfit font-lexend text-2xl sm:text-3xl font-[500]">
      ...
      >
        <div className="max-w-[93%] mx-auto grid grid-cols-1 gap-8 text-white">
          ...
          {/* Right Column */}
          <div className="flex flex-col justify-start items-start mt-4" style={{ marginTop: "15px" }}>
            <h3 className="font-lexend text-2xl sm:text-3xl font-[500] text-left">
              Contact Us
            </h3>
            <div className="flex flex-col items-start space-y-2 font-outfit font-lexend text-2xl sm:text-3xl font-[500]" style={{marginTop:"15px"}}>
              <a href="#" className="hover:text-white transition">
                Facebook
              </a>
              <a href="#" className="hover:text-white transition">
